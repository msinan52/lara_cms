...
<div class="container">
    ...
    <p>Siparişini Aldık Bizi Tercih ettiğiniz için teşekkür ederiz</p>

    <h4>Siparis Kodu : SP-{{ $order->id }}</h4>
    <p>Daha fazla bilgi için bizimle iletişime geçebilirsin Mail : {{ $site->mail }} Site: {{ $site->domain }}</p>
    <hr>
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="text-right">{{ $prices['cartSubTotalPrice'] }} ₺</td>
            </tr>
            ...
            <tr>
                ...
                <td class="text-right">{{ $prices['cargoPrice'] }} ₺</td>
            </tr>
            <tr>
