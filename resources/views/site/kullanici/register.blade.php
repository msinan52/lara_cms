            ...
            <div class="col-lg-8">
                <ul class="checkout-steps">
                    <li>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('kullaniciRegisterView') }}">
                            @csrf
                            <div class="form-row">
                            ...
                            <p>Mevcut bir hesabınız varsa <a href="{{route('kullaniciLoginView')}}">giriş</a> yapabilirsiniz.</p>
                        </form>
