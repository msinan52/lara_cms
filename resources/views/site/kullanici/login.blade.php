            ...
            <div class="col-lg-8">
                <ul class="checkout-steps">
                    <li>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('kullaniciLoginView') }}">
                            {{ csrf_field() }}
                            ...
                            <p>Mevcut bir hesabınız yoksa <a href="{{route('kullaniciRegisterView')}}">kaydolabilir</a> veya misafir olarak devam edebilirsin.</p>
                        </form>
