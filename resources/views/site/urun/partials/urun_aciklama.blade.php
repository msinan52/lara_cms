        ...
        <div class="tab-pane fade" id="product-reviews-content" role="tabpanel" aria-labelledby="product-tab-reviews">
            <div class="product-reviews-content">
                <div class="collateral-box">
                    <ul>
                        <li>Bu ürüne toplamda {{ $urun->comments_count }} yorum yapılmıştır. @auth()
                                <a href="#makeNewComment">yorum yap</a>
                            @elseauth()
                                Yorum yapmak için <a href="{{ route('kullaniciLoginView') }}">giriş</a> yapmalısın
                            @endauth</li>
                    ...
                    @auth()
                        <div id="makeNewComment">
                            <form action="{{ route('product.comments.add') }}" method="post">
                                ...
                                <input type="hidden" name="product_slug" value="{{ $urun->slug }}">
