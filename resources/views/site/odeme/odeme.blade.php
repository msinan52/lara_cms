                                    ...
                                    <td class="product-col">
                                        <figure class="product-image-container">
                                            <a href="{{ route('productDetail',$item->options->slug) }}" class="product-image">
                                                <img src="{{config('constants.image_paths.product_image_folder_path').$item->options->image}}" alt="product">
                                            </a>
                                        </figure>
                                        <div>
...
{{--                        <a href="javascript:void();" onclick="document.getElementById('paymentForm').submit()" class="btn btn-block btn-sm btn-primary">Ödeme Yap</a>--}}
{{--                    </div>--}}
                </div>
                ...
                <div class="checkout-info-box">
                    ...
                    <p>Standart Taşıma Kargo Ücreti - {{ $prices['cargoPrice'] }} ₺ </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control kredikarti" id="kartno" name="cardnumber" onchange="getInstallmentDetails({{ Cart::total() }})"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="text" class="form-control kredikarti_cvv" name="cardcvv2" id="cardcvv2" value="111"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
