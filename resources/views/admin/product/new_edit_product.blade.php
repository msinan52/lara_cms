    ...
    <form role="form" method="post" action="{{ route('admin.product.save',$product->id != null ? $product->id : 0) }}" id="form" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Ürün Açıklama -->
                <div class="row">
                    <div class="col-md-{{ config('admin.product_attribute') ? '6': '12' }}">
                        <div class="box box-primary">
                    ...
                    @if(config('admin.product_attribute'))
                        <div class="col-md-6">
                            <div class="box box-primary">
                ...
                @if(config('admin.product_feature'))
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                ...
                @endif
                @if(config('admin.product_variant'))
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                ...
                @endif
                @if(config('admin.product_gallery'))
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
