        ...
        <div class="box-body with-border">
            <div class="row">
                ...
                <div class="col-md-2 text-right mr-3">
                    <a href="{{ route('admin.config.new') }}"> <i class="fa fa-plus"></i> Yeni Ayar Ekle</a>&nbsp;
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        @if(count($list) > 0)
                            @foreach($list as $l)
                                <tr>
                                    <td>{{ $l ->id }}</td>
                                    <td><a href="{{ route('admin.config.edit',$l->id) }}"> {{ $l->title }}</a></td>
                                    <td>{{ $l ->domain }}</td>
                                    <td>{{ $l ->logo }}</td>
                                    <td>{{ $l ->icon }}</td>
                                    <td>{{ $l ->tel }}</td>
                                    ...
                                    <td>{{ $l ->twitter }}</td>
                                    <td>{{ $l ->instagram }}</td>
                                    <td> <a href="{{ route('admin.config.edit',$l->id) }}"><i class="fa fa-edit text-green"></i></a></td>
