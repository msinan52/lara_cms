                        ...
                        @if(count($list) > 0)
                            @foreach($list as $l)
                                <tr>
                                    ...
                                    <td>{{ strip_tags(str_limit($l -> desc,100))}}</td>
                                    ...
                                    <td>
                                        @if($l->image)
                                            <a target="_blank" href="{{ config('constants.image_paths.blog_image_folder_path').''. $l ->image }}">
                                                <img src="{{ config('constants.image_paths.blog_image_folder_path').''. $l ->image }}" alt="" width="50" height="50"></a>
                                        @endif
                                    </td>
