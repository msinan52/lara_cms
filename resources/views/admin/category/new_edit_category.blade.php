    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{ route('admin.category.save',$category->id != null ? $category->id : 0) }}" id="form">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-row">
                        ...
                        <div class="form-group col-md-1">
                            ...
                            <input type="text" class="form-control" id="row" name="row" placeholder="listelemede kullanıcılacak sıra numarası"
