                ...
                <form role="form" method="post" action="{{ route('admin.coupons.save',$entry->id != null ? $entry->id : 0) }}" id="form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="exampleInputEmail1">Minumum Basket Tutarı</label>
                                <input type="number" class="form-control" name="min_basket_price" placeholder="Minumum Basket Tutarı"
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <input type="checkbox" class="minimal" name="active" {{ $entry->active == 1 ? 'checked': '' }}>
                            </div>
